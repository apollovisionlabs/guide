...
describe('Spotlight', () => {
  ...
  it('cuts a hole the size of the target, padding included', () => {
    render(<Spotlight rect={rect} padding={8} radius={6} />)
    const hole = document.querySelector('mask rect:last-of-type')
  ...
  it('carries the documented class and data-guide-part', () => {
    render(<Spotlight rect={rect} />)
    const svg = screen.getByTestId('guide-spotlight')
