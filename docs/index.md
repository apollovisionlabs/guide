...
These pre-existing documents are the authoritative record of intent and execution for the current
codebase. They are left exactly where they are and carry no OKF frontmatter:

- `docs/superpowers/specs/2026-09-02-guide-onboarding-design.md`: the validated design for the tour.
- `docs/superpowers/plans/2026-09-02-guide-tour.md`: the tour's implementation plan.
- `docs/superpowers/specs/2026-09-03-guide-checklist-design.md`: the validated design for the
  checklist.
- `docs/superpowers/plans/2026-09-03-guide-checklist.md`: the checklist's implementation plan.
- `docs/superpowers/specs/2026-09-04-guide-actions-and-hotspots-design.md`: the validated design
  for advancing on an action and for hotspots.
- `docs/superpowers/plans/2026-09-04-guide-actions-and-hotspots.md`: their implementation plan.
  Superseded where it disagrees with the merged code; see `docs/log.md` for the corrections.
