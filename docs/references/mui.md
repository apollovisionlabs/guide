...
type: Reference
title: MUI
description: The Material UI component library that @apollovisionlabs/guide-mui renders with.
...
The component library `@apollovisionlabs/guide-mui` builds on. Only a small surface is used, namely `Box`, `Button`,
